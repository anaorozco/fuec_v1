 ...
 * the License.
 */
package com.gmail.anamara.ui.views.categorieslist;
...
public class CategoriesList extends VerticalLayout {
    ...
    private final TextField searchField = new TextField("",
            "Buscar FUEC");
    private final H2 header = new H2("Extracto Unico de Contrato (FUEC) para empresas de Servicio de Transporte Especial");
    ...
    private void addSearchBar() {
        ...
        Button newButton = new Button("Nuevo", new Icon("lumo", "plus"));
    ...
    private void addContent() {
        ...
        grid.addColumn(Category::getName).setHeader("Name").setWidth("8em")
                .setResizable(true);
        grid.addColumn(this::getReviewCount).setHeader("Descripción")
                .setWidth("6em");
    ...
    private void updateView() {
        ...
        if (searchField.getValue().length() > 0) {
            header.setText("Buscar FUEC “" + searchField.getValue() + "”");
        } else {
            header.setText("FUEC");
        }
    }
    ...
    private void saveCategory(Category category,
        ...
        Notification.show(
                "Agregado exitosamente. " + operation.getNameInText() + "ed.",
    ...
    private void deleteCategory(Category category) {
        ...
        Notification.show("Eliminado exitosamente.", 3000,
