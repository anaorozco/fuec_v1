...
public class Review implements Serializable {
    ...
    /** Info regarding FUEC generation and authorization **/
    
    private Contract contrato_transporte;
    ...
    public Review(int score, String name, LocalDate date, Category category,
        ...
        this.count = count;
        this.contrato_transporte = new Contract();
    }
    
    public Review(int score, String name, LocalDate date, Category category,
            int count, String driver, String idfuec) {
        this.score = score;
        this.name = name;
        this.date = date;
        this.category = new Category(category);
